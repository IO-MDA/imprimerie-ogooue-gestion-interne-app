...
export default function TravauxV2() {
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-slate-500">Module complet de suivi de travaux</p>
          </div>
          {isAdmin && (
            <Button 
                              ...
                              <CardContent className="space-y-4">
                                <div className="grid grid-cols-3 gap-4 text-sm">
                                  ...
                                  <div>
                                    ...
                                    <p className="font-semibold text-blue-600">{cat.budget_depense.toLocaleString()} F</p>
                                  </div>
                                  <div>
                                    <p className="text-slate-500">Avancement</p>
                                    <p className="font-semibold text-purple-600">{cat.avancement.toFixed(0)}%</p>
                                  </div>
                                </div>
