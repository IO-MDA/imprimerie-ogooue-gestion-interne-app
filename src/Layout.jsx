...
export default function Layout({ children, currentPageName }) {
  ...
  const allNavigation = [
                    ...
                    { name: 'Demandes modification', href: 'DemandeModification', icon: FileCheck, roles: ['admin', 'manager', 'user'] },
                    ...
                    { name: 'Objectifs', href: 'Objectifs', icon: Target, roles: ['admin', 'manager', 'user'] },
                    ...
                    { name: 'Devis & Factures', href: 'DevisFactures', icon: Receipt, roles: ['admin', 'manager', 'user'] },
                    ...
                    { 
                      name: 'Demandes modification admin', 
